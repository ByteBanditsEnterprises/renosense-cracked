...
{
    private static final CustomFont customFont;
    ...
    private static Texture rLoad;
    private static Texture rBG;
    private static Texture rLogo;
    ...
    public static void start() throws IOException {
        ...
        final ResourceLocation renoBG = new ResourceLocation("textures/loading/forge.png");
        final ResourceLocation renoLoad = new ResourceLocation("textures/loading/load.png");
        final ResourceLocation renoLogo = new ResourceLocation("textures/loading/renosense.png");
        ...
        (CustomSplashProgress.thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                CustomSplashProgress.rBG = new Texture(renoBG, null);
                CustomSplashProgress.rLoad = new Texture(renoLoad, null);
                CustomSplashProgress.rLogo = new Texture(renoLogo, null);
                GL11.glEnable(3553);
                ...
                while (!CustomSplashProgress.done) {
                    ...
                    GL11.glPushMatrix();
                    GL11.glEnable(3553);
                    CustomSplashProgress.rBG.bind();
                    GL11.glBegin(7);
                    CustomSplashProgress.rBG.texCoord(0, 0.0f, 0.0f);
                    GL11.glVertex2f((float)left, (float)top);
                    CustomSplashProgress.rBG.texCoord(0, 0.0f, 1.0f);
                    GL11.glVertex2f((float)left, (float)bottom);
                    CustomSplashProgress.rBG.texCoord(0, 1.0f, 1.0f);
                    GL11.glVertex2f((float)right, (float)bottom);
                    CustomSplashProgress.rBG.texCoord(0, 1.0f, 0.0f);
                    GL11.glVertex2f((float)right, (float)top);
                    GL11.glEnd();
                    GL11.glDisable(3553);
                    GL11.glPopMatrix();
                    ...
                    GL11.glPushMatrix();
                    final int scale = 2;
                    final int fontY = bottom - 37 - CustomSplashProgress.customFont.getHeight();
                    final int fontX = right - 10;
                    ...
                    GL11.glEnable(3553);
                    CustomSplashProgress.customFont.drawStringWithShadow(progress, (double)(fontX / (float)scale - CustomSplashProgress.customFont.getStringWidth(progress) - 5.0f), (double)(fontY / (float)scale), -1);
                    GL11.glPopMatrix();
                    GL11.glPopMatrix();
            ...
            private void setGL() {
                System.out.println("Setting RenoSense Loading Screen!");
    ...
    static {
        customFont = new CustomFont(new Font("Arial", 0, 30), true, false);
        CustomSplashProgress.pause = false;
