...
public class WindowUtils
{
    ...
    public abstract static class NativeWindowUtils
    {
        ...
        protected Shape toShape(final Raster raster) {
            ...
            RasterRangesUtils.outputOccupiedRanges(raster, (RasterRangesUtils.RangesOutput)new RasterRangesUtils.RangesOutput() {
    ...
    private static class W32WindowUtils extends NativeWindowUtils
    {
        ...
        public BufferedImage getWindowIcon(final WinDef.HWND hwnd) {
            ...
            final Pointer lpBitsColorPtr = (Pointer)new Memory((long)lpBitsColor.length);
            final byte[] lpBitsMask = new byte[width * height * 24 / 8];
            final Pointer lpBitsMaskPtr = (Pointer)new Memory((long)lpBitsMask.length);
            ...
            hdr.write();
            bitmapInfo.write();
            final WinDef.HDC hDC = User32.INSTANCE.GetDC((WinDef.HWND)null);
        ...
        public Dimension getIconSize(final WinDef.HICON hIcon) {
            ...
            try {
                ...
                if (iconInfo.hbmColor != null && iconInfo.hbmColor.getPointer() != Pointer.NULL) {
                    final int nWrittenBytes = GDI32.INSTANCE.GetObject((WinNT.HANDLE)iconInfo.hbmColor, bmp.size(), bmp.getPointer());
                    bmp.read();
                    if (nWrittenBytes > 0) {
                    ...
                    final int nWrittenBytes = GDI32.INSTANCE.GetObject((WinNT.HANDLE)iconInfo.hbmMask, bmp.size(), bmp.getPointer());
                    bmp.read();
                    if (nWrittenBytes > 0) {
        ...
        public List<DesktopWindow> getAllWindows(final boolean onlyVisibleWindows) {
            ...
            final WinUser.WNDENUMPROC lpEnumFunc = (WinUser.WNDENUMPROC)new WinUser.WNDENUMPROC() {
