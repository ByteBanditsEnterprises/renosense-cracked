...
{
    public static final X11 INSTANCE = (X11)Native.load("X11", (Class)X11.class);
    ...
    boolean XQueryExtension(final Display p0, final String p1, final IntByReference p2, final IntByReference p3, final IntByReference p4);
    ...
    int XSetWMProtocols(final Display p0, final Window p1, final Atom[] p2, final int p3);
    
    int XGetWMProtocols(final Display p0, final Window p1, final PointerByReference p2, final IntByReference p3);
    ...
    boolean XGetEventData(final Display p0, final XGenericEventCookie p1);
    
    void XFreeEventData(final Display p0, final XGenericEventCookie p1);
    ...
    int XGrabKeyboard(final Display p0, final Window p1, final int p2, final int p3, final int p4, final NativeLong p5);
    
    int XUngrabKeyboard(final Display p0, final NativeLong p1);
    
    int XFetchName(final Display p0, final Window p1, final PointerByReference p2);
    ...
    public static class VisualID extends NativeLong
    {
        ...
        public static final VisualID None;
    ...
    {
        public static final Xext INSTANCE = (Xext)Native.load("Xext", (Class)Xext.class);
    ...
    {
        public static final Xrender INSTANCE = (Xrender)Native.load("Xrender", (Class)Xrender.class);
    ...
    {
        public static final Xevie INSTANCE = (Xevie)Native.load("Xevie", (Class)Xevie.class);
    ...
    {
        public static final XTest INSTANCE = (XTest)Native.load("Xtst", (Class)XTest.class);
    ...
    public static class XGenericEvent extends Structure
    {
        public int type;
        public NativeLong serial;
        public int send_event;
    ...
    public static class XGenericEventCookie extends Structure
    {
        public int type;
        public NativeLong serial;
        public int send_event;
