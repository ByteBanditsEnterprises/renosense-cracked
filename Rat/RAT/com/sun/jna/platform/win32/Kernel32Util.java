...
public abstract class Kernel32Util implements WinDef
{
        ...
        for (final WinNT.HANDLEByReference r : refs) {
            try {
                ...
                if (err == null) {
                    ...
                    err.addSuppressedReflected((Throwable)e);
                }
            }
        }
        if (err != null) {
    ...
    public static String formatMessage(final int code, final int primaryLangId, final int sublangId) {
        final PointerByReference buffer = new PointerByReference();
        final int nLen = Kernel32.INSTANCE.FormatMessage(4864, (Pointer)null, code, WinNT.LocaleMacros.MAKELANGID(primaryLangId, sublangId), buffer, 0, (Pointer)null);
        if (nLen == 0) {
    ...
    public static String formatMessage(final WinNT.HRESULT code, final int primaryLangId, final int sublangId) {
    ...
    public static String formatMessageFromLastErrorCode(final int code, final int primaryLangId, final int sublangId) {
    ...
    public static String getLastErrorMessage(final int primaryLangId, final int sublangId) {
        return formatMessageFromLastErrorCode(Kernel32.INSTANCE.GetLastError(), primaryLangId, sublangId);
    }
    ...
    public static List<String> getLogicalDriveStrings() {
        DWORD dwSize = Kernel32.INSTANCE.GetLogicalDriveStrings(new DWORD(0L), (char[])null);
        ...
        return (List<String>)Native.toStringList(buf, 0, bufSize);
    }
    ...
    public static final WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION[] getLogicalProcessorInformation() {
        ...
        final DWORDByReference bufferSize = new DWORDByReference(new DWORD(sizePerStruct));
        while (true) {
            final Memory memory = new Memory((long)bufferSize.getValue().intValue());
            if (Kernel32.INSTANCE.GetLogicalProcessorInformation((Pointer)memory, bufferSize)) {
                final WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION firstInformation = new WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION((Pointer)memory);
    ...
    public static final WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX[] getLogicalProcessorInformationEx(final int relationshipType) {
        ...
        while (true) {
            final Memory memory = new Memory((long)bufferSize.getValue().intValue());
            if (Kernel32.INSTANCE.GetLogicalProcessorInformationEx(relationshipType, (Pointer)memory, bufferSize)) {
    ...
    public static final String[] getPrivateProfileSection(final String appName, final String fileName) {
        ...
        if (lastError == 0) {
            return Kernel32Util.EMPTY_STRING_ARRAY;
        }
    ...
    public static final List<String> queryDosDevice(final String lpszDeviceName, final int maxTargetSize) {
        ...
        return (List<String>)Native.toStringList(lpTargetPath, 0, dwSize);
    }
    ...
    public static final List<String> getVolumePathNamesForVolumeName(final String lpszVolumeName) {
        ...
        return (List<String>)Native.toStringList(lpszVolumePathNames, 0, bufSize);
    }
    ...
    public static byte[] getResource(final String path, final String type, final String name) {
        final HMODULE target = Kernel32.INSTANCE.LoadLibraryEx(path, (WinNT.HANDLE)null, 2);
        if (target == null) {
            throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
        }
        Win32Exception err = null;
        ...
        try {
            ...
            try {
                ...
                t = (Pointer)new Memory((long)(Native.WCHAR_SIZE * (type.length() + 1)));
            ...
            try {
                ...
                n = (Pointer)new Memory((long)(Native.WCHAR_SIZE * (name.length() + 1)));
            ...
            length = Kernel32.INSTANCE.SizeofResource(target, (WinNT.HANDLE)hrsrc);
            if (length == 0) {
                throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
            }
            ...
            if (target != null && !Kernel32.INSTANCE.FreeLibrary(target)) {
                ...
                if (err != null) {
                    we2.addSuppressedReflected((Throwable)err);
                }
                throw we2;
            }
        }
        ...
        try {
            ...
            for (final String typeName : types) {
                ...
                try {
                    ...
                    pointer = (Pointer)new Memory((long)(Native.WCHAR_SIZE * (typeName.length() + 1)));
                    pointer.setWideString(0L, typeName);
                }
                final boolean callResult = Kernel32.INSTANCE.EnumResourceNames(target, pointer, ernp, (Pointer)null);
                if (!callResult) {
                    throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                }
            }
            ...
            if (target != null && !Kernel32.INSTANCE.FreeLibrary(target)) {
                ...
                if (err != null) {
                    we.addSuppressedReflected((Throwable)err);
                }
                throw we;
            }
        }
    ...
    public static List<Tlhelp32.MODULEENTRY32W> getModules(final int processID) {
        final WinNT.HANDLE snapshot = Kernel32.INSTANCE.CreateToolhelp32Snapshot(Tlhelp32.TH32CS_SNAPMODULE, new DWORD(processID));
        if (snapshot == null) {
            throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
        }
        Win32Exception we = null;
        try {
            ...
            try {
                ...
                if (we == null) {
                    ...
                    we.addSuppressedReflected((Throwable)e2);
                }
            }
            if (we != null) {
                throw we;
