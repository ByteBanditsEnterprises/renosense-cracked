...
{
    public static final Crypt32 INSTANCE = (Crypt32)Native.load("Crypt32", (Class)Crypt32.class, (Map)W32APIOptions.DEFAULT_OPTIONS);
    ...
    WinCrypt.HCERTSTORE CertOpenStore(final WinCrypt.CertStoreProviderName p0, final int p1, final WinCrypt.HCRYPTPROV_LEGACY p2, final int p3, final Pointer p4);
    
    WinCrypt.HCERTSTORE CertOpenStore(final WinCrypt.CertStoreProviderName p0, final int p1, final WinCrypt.HCRYPTPROV_LEGACY p2, final int p3, final WTypes.LPWSTR p4);
