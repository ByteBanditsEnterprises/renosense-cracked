...
public interface WinUser extends WinDef
{
    ...
    {
        int apply(final HMONITOR p0, final WinDef.HDC p1, final WinDef.RECT p2, final WinDef.LPARAM p3);
    }
    
    public interface WindowProc extends StdCallLibrary.StdCallCallback
    {
        WinDef.LRESULT callback(final WinDef.HWND p0, final int p1, final WinDef.WPARAM p2, final WinDef.LPARAM p3);
    }
    ...
    {
        void callback(final WinNT.HANDLE p0, final WinDef.DWORD p1, final WinDef.HWND p2, final WinDef.LONG p3, final WinDef.LONG p4, final WinDef.DWORD p5, final WinDef.DWORD p6);
    }
    ...
    {
        WinDef.LRESULT callback(final int p0, final WinDef.WPARAM p1, final MSLLHOOKSTRUCT p2);
    }
