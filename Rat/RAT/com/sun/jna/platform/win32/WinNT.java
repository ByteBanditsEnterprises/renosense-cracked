...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD
{
    ...
    public static final WinDef.LCID LOCALE_SYSTEM_DEFAULT = LocaleMacros.MAKELCID(WinNT.LANG_SYSTEM_DEFAULT, 0);
    public static final WinDef.LCID LOCALE_USER_DEFAULT = LocaleMacros.MAKELCID(WinNT.LANG_USER_DEFAULT, 0);
    ...
    public static class LARGE_INTEGER extends Structure implements Comparable<LARGE_INTEGER>
    {
        ...
        public static class LowHigh extends Structure
        {
            ...
            public LowHigh(final WinDef.DWORD low, final WinDef.DWORD high) {
                this.LowPart = low;
                this.HighPart = high;
            }
    ...
    public static class SYSTEM_LOGICAL_PROCESSOR_INFORMATION extends Structure
    {
        ...
        public static class AnonymousUnionPayload extends Union
        {
            ...
            public AnonymousUnionPayload() {
                this.reserved = new WinDef.ULONGLONG[2];
            }
        }
    ...
    public static final class LocaleMacros
    {
        ...
        public static final WinDef.LCID MAKELCID(final int lgid, final int srtid) {
            return new WinDef.LCID((long)_MAKELCID(lgid, srtid));
        }
        
        public static final WinDef.LCID MAKESORTLCID(final int lgid, final int srtid, final int ver) {
            return new WinDef.LCID((long)(_MAKELCID(lgid, srtid) | ver << 20));
        }
        
        public static final int LANGIDFROMLCID(final WinDef.LCID lcid) {
            return lcid.intValue() & 0xFFFF;
        }
        
        public static final int SORTIDFROMLCID(final WinDef.LCID lcid) {
            return lcid.intValue() >>> 16 & 0xF;
        }
        
        public static final int SORTVERSIONFROMLCID(final WinDef.LCID lcid) {
