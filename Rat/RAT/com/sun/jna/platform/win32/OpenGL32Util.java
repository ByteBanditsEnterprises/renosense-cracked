...
public abstract class OpenGL32Util
{
    public static Function wglGetProcAddress(final String procName) {
        final Pointer funcPointer = OpenGL32.INSTANCE.wglGetProcAddress(procName);
    ...
    public static int countGpusNV() {
        ...
        for (int i = 0; i < 16; ++i) {
            final Boolean ok = (Boolean)fncEnumGpusNV.invoke((Class)Boolean.class, new Object[] { i, hGPU });
            if (!ok) {
                return i;
            }
        }
