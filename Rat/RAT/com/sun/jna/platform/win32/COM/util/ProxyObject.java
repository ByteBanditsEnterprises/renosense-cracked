...
public class ProxyObject implements InvocationHandler, IDispatch, IRawDispatchHandle, IConnectionPoint
{
    ...
    private long getUnknownId() {
        ...
        if (-1L == this.unknownId) {
            try {
                ...
                throw new COMException("Error occured when trying get Unknown Id ", (Throwable)e);
            }
        }
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        ...
        Label_0105: {
            if (!declaredAsInterface) {
                if (!method.getDeclaringClass().equals(Object.class) && !method.getDeclaringClass().equals(IRawDispatchHandle.class) && !method.getDeclaringClass().equals(com.sun.jna.platform.win32.COM.util.IUnknown.class) && !method.getDeclaringClass().equals(IDispatch.class)) {
    ...
    public IComEventCallbackCookie advise(final Class<?> comEventCallbackInterface, final IComEventCallbackListener comEventCallbackListener) throws COMException {
        ...
        try {
            ...
            final IDispatchCallback rawListener = this.factory.createDispatchCallback((Class)comEventCallbackInterface, comEventCallbackListener);
            ...
            final WinNT.HRESULT hr = rawCp.Advise((IUnknownCallback)rawListener, pdwCookie);
            final int n = rawCp.Release();
            COMUtils.checkRC(hr);
            return (IComEventCallbackCookie)new ComEventCallbackCookie(pdwCookie.getValue());
        }
        catch (RuntimeException e) {
            if (e instanceof COMException) {
                throw e;
            }
            throw new COMException("Error occured in advise when trying to connect the listener " + comEventCallbackListener, (Throwable)e);
        }
    }
    ...
    public void unadvise(final Class<?> comEventCallbackInterface, final IComEventCallbackCookie cookie) throws COMException {
        ...
        try {
            ...
            throw new COMException("Error occured in unadvise when trying to disconnect the listener from " + this, (Throwable)e);
        }
    }
    ...
    public <T> void setProperty(final OaIdl.DISPID dispId, final T value) {
        assert COMUtils.comIsInitialized() : "COM not initialized";
        final Variant.VARIANT v = Convert.toVariant((Object)value);
        final WinNT.HRESULT hr = this.oleMethod(4, null, this.getRawDispatch(), dispId, v);
        Convert.free(v, (Object)value);
        COMUtils.checkRC(hr);
    }
    ...
    public <T> T getProperty(final Class<T> returnType, final OaIdl.DISPID dispID, final Object... args) {
        ...
        COMUtils.checkRC(hr);
        return (T)Convert.toJavaObject((Variant.VARIANT)result, (Class)returnType, this.factory, false, true);
    }
    ...
    public <T> T queryInterface(final Class<T> comInterface) throws COMException {
        ...
        try {
            ...
            if (WinNT.S_OK.equals((Object)hr)) {
                final Dispatch dispatch = new Dispatch(ppvObject.getValue());
                final T t = (T)this.factory.createProxy((Class)comInterface, (com.sun.jna.platform.win32.COM.IDispatch)dispatch);
            ...
            throw new COMException("Error occured when trying to query for interface " + comInterface.getName(), (Throwable)e);
        }
    }
    ...
    protected WinNT.HRESULT oleMethod(final int nType, final Variant.VARIANT.ByReference pvResult, final com.sun.jna.platform.win32.COM.IDispatch pDisp, final OaIdl.DISPID dispId, final Variant.VARIANT[] pArgs) throws COMException {
        ...
        final WinNT.HRESULT hr = pDisp.Invoke(dispId, new Guid.REFIID(Guid.IID_NULL), this.factory.getLCID(), new WinDef.WORD(finalNType), dp, pvResult, pExcepInfo, puArgErr);
