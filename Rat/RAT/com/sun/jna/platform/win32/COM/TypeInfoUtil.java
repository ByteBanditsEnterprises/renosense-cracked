...
public class TypeInfoUtil
{
    ...
    public OaIdl.FUNCDESC getFuncDesc(final int index) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetFuncDesc(new WinDef.UINT(index), ppFuncDesc);
        COMUtils.checkRC(hr);
    ...
    public OaIdl.VARDESC getVarDesc(final int index) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetVarDesc(new WinDef.UINT(index), ppVarDesc);
        COMUtils.checkRC(hr);
    ...
    public String[] getNames(final OaIdl.MEMBERID memid, final int maxNames) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetNames(memid, rgBstrNames, new WinDef.UINT(maxNames), pcNames);
        COMUtils.checkRC(hr);
    ...
    public OaIdl.HREFTYPE getRefTypeOfImplType(final int index) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetRefTypeOfImplType(new WinDef.UINT(index), ppTInfo);
        COMUtils.checkRC(hr);
    ...
    public int getImplTypeFlags(final int index) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetImplTypeFlags(new WinDef.UINT(index), pImplTypeFlags);
        COMUtils.checkRC(hr);
    ...
    public OaIdl.MEMBERID[] getIDsOfNames(final WTypes.LPOLESTR[] rgszNames, final int cNames) {
        ...
        final WinNT.HRESULT hr = this.typeInfo.GetIDsOfNames(rgszNames, new WinDef.UINT(cNames), pMemId);
        COMUtils.checkRC(hr);
        return pMemId;
    }
    ...
    public ITypeInfo getRefTypeInfo(final OaIdl.HREFTYPE hreftype) {
        ...
        COMUtils.checkRC(hr);
        return (ITypeInfo)new TypeInfo(ppTInfo.getValue());
    }
    ...
    public ContainingTypeLib GetContainingTypeLib() {
        ...
        COMUtils.checkRC(hr);
        return new ContainingTypeLib((ITypeLib)new TypeLib(ppTLib.getValue()), pIndex.getValue().intValue());
    }
