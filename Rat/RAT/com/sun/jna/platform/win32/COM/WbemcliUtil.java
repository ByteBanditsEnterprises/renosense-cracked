...
public class WbemcliUtil
{
    ...
    public static Wbemcli.IWbemServices connectServer(final String namespace) {
        ...
        final Wbemcli.IWbemServices services = loc.ConnectServer(namespace, (String)null, (String)null, (String)null, 0, (String)null, (Wbemcli.IWbemContext)null);
        loc.Release();
        final WinNT.HRESULT hres = Ole32.INSTANCE.CoSetProxyBlanket((Unknown)services, 10, 0, null, 3, 3, null, 0);
        ...
        private static <T extends Enum<T>> WmiResult<T> enumerateProperties(final Wbemcli.IEnumWbemClassObject enumerator, final Class<T> propertyEnum, final int timeout) throws TimeoutException {
            ...
            while (enumerator.getPointer() != Pointer.NULL) {
                ...
                for (final T property2 : propertyEnum.getEnumConstants()) {
                    clsObj.Get((WString)wstrMap.get(property2), 0, pVal, pType, (IntByReference)null);
                    final int vtType = ((Number)((pVal.getValue() == null) ? Integer.valueOf(1) : pVal.getVarType())).intValue();
