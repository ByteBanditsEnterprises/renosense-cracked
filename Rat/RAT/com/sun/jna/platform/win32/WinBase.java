...
public interface WinBase extends WinDef, BaseTSD
{
    ...
    public static class FILE_BASIC_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_BASIC_INFO.class, (Object)null);
        }
    ...
    public static class FILE_STANDARD_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_STANDARD_INFO.class, (Object)null);
        }
    ...
    public static class FILE_DISPOSITION_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_DISPOSITION_INFO.class, (Object)null);
        }
    ...
    public static class FILE_COMPRESSION_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_COMPRESSION_INFO.class, (Object)null);
        }
    ...
    public static class FILE_ATTRIBUTE_TAG_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_ATTRIBUTE_TAG_INFO.class, (Object)null);
        }
    ...
    public static class FILE_ID_INFO extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)FILE_ID_INFO.class, (Object)null);
        }
    ...
    public static class WIN32_FIND_DATA extends Structure
    {
        ...
        public static int sizeOf() {
            return Native.getNativeSize((Class)WIN32_FIND_DATA.class, (Object)null);
        }
    ...
    public static class MEMORYSTATUSEX extends Structure
    {
        ...
        public MEMORYSTATUSEX() {
            this.dwLength = new DWORD(this.size());
        }
    }
    ...
    public static class DCB extends Structure
    {
        ...
        public DCB() {
            this.DCBlength = new DWORD(this.size());
        }
