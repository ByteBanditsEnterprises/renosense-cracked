...
public abstract class Crypt32Util
{
    ...
    public static String CertNameToStr(final int dwCertEncodingType, final int dwStrType, final WinCrypt.DATA_BLOB pName) {
        ...
        final Memory mem = new Memory((long)(requiredSize * charToBytes));
        final int resultBytes = Crypt32.INSTANCE.CertNameToStr(dwCertEncodingType, pName, dwStrType, (Pointer)mem, requiredSize);
