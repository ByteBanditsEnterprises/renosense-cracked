...
{
    public static final Kernel32 INSTANCE = (Kernel32)Native.load("kernel32", (Class)Kernel32.class, (Map)W32APIOptions.DEFAULT_OPTIONS);
    ...
    boolean VirtualLock(final Pointer p0, final BaseTSD.SIZE_T p1);
    
    boolean VirtualUnlock(final Pointer p0, final BaseTSD.SIZE_T p1);
}
