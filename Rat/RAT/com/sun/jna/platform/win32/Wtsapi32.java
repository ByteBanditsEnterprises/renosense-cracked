...
{
    public static final Wtsapi32 INSTANCE = (Wtsapi32)Native.load("Wtsapi32", (Class)Wtsapi32.class, (Map)W32APIOptions.DEFAULT_OPTIONS);
    ...
    public static final WinNT.HANDLE WTS_CURRENT_SERVER_HANDLE = new WinNT.HANDLE((Pointer)null);
