    ...
    public enum MC_DISPLAY_TECHNOLOGY_TYPE
    {
        ...
        public static class ByReference extends com.sun.jna.ptr.ByReference
        {
            ...
            public MC_DISPLAY_TECHNOLOGY_TYPE getValue() {
                return (MC_DISPLAY_TECHNOLOGY_TYPE)EnumUtils.fromInteger(this.getPointer().getInt(0L), (Class)MC_DISPLAY_TECHNOLOGY_TYPE.class);
            }
        }
    }
    ...
    public enum MC_COLOR_TEMPERATURE
    {
        ...
        public static class ByReference extends com.sun.jna.ptr.ByReference
        {
            ...
            public MC_COLOR_TEMPERATURE getValue() {
                return (MC_COLOR_TEMPERATURE)EnumUtils.fromInteger(this.getPointer().getInt(0L), (Class)MC_COLOR_TEMPERATURE.class);
            }
        }
    }
}
