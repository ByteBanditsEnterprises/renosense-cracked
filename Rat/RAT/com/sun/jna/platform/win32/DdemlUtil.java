...
public abstract class DdemlUtil
{
    ...
    public static class DdeConnection implements IDdeConnection
    {
        ...
        public void abandonTransaction(final int transactionId) {
            final boolean result = Ddeml.INSTANCE.DdeAbandonTransaction((int)this.client.getInstanceIdentitifier(), this.conv, transactionId);
            if (!result) {
        ...
        @Override
        public void abandonTransactions() {
            final boolean result = Ddeml.INSTANCE.DdeAbandonTransaction((int)this.client.getInstanceIdentitifier(), this.conv, 0);
            if (!result) {
                throw DdemlException.create(this.client.getLastError());
            }
        }
        ...
        public void execute(final String executeString, final int timeout, final WinDef.DWORDByReference result, final BaseTSD.DWORD_PTR userHandle) {
            final Memory mem = new Memory((long)(executeString.length() * 2 + 2));
        ...
        @Override
        public boolean enableCallback(final int wCmd) {
            final boolean result = Ddeml.INSTANCE.DdeEnableCallback((int)this.client.getInstanceIdentitifier(), this.conv, wCmd);
            if (!result && wCmd == 2) {
                throw DdemlException.create(this.client.getLastError());
            }
            return result;
    ...
    public static class DdeClient implements IDdeClient
    {
        ...
        public void initialize(final int afCmd) throws DdemlException {
            ...
            final Integer result = Ddeml.INSTANCE.DdeInitialize(pidInst, (Ddeml.DdeCallback)this.ddeAdapter, afCmd, 0);
            if (result != 0) {
        ...
        public Ddeml.HSZ createStringHandle(final String value) throws DdemlException {
            ...
            final Ddeml.HSZ handle = Ddeml.INSTANCE.DdeCreateStringHandle((int)this.idInst, value, codePage);
            if (handle == null) {
        ...
        @Override
        public void nameService(final Ddeml.HSZ name, final int afCmd) throws DdemlException {
            final Ddeml.HDDEDATA handle = Ddeml.INSTANCE.DdeNameService((int)this.idInst, name, new Ddeml.HSZ(), afCmd);
            if (handle == null) {
                throw DdemlException.create(this.getLastError());
            }
        }
        ...
        @Override
        public int getLastError() {
            return Ddeml.INSTANCE.DdeGetLastError((int)this.idInst);
        }
        
        @Override
        public IDdeConnection connect(final Ddeml.HSZ service, final Ddeml.HSZ topic, final Ddeml.CONVCONTEXT convcontext) {
            final Ddeml.HCONV hconv = Ddeml.INSTANCE.DdeConnect((int)this.idInst, service, topic, convcontext);
            if (hconv == null) {
                throw DdemlException.create(this.getLastError());
            }
        ...
        public String queryString(final Ddeml.HSZ value) throws DdemlException {
            ...
            final Memory buffer = new Memory((long)(257 * byteWidth));
            try {
                final int length = Ddeml.INSTANCE.DdeQueryString((int)this.idInst, value, (Pointer)buffer, 256, codePage);
                if (W32APIOptions.DEFAULT_OPTIONS == W32APIOptions.UNICODE_OPTIONS) {
        ...
        @Override
        public Ddeml.HDDEDATA createDataHandle(final Pointer pSrc, final int cb, final int cbOff, final Ddeml.HSZ hszItem, final int wFmt, final int afCmd) {
            final Ddeml.HDDEDATA returnData = Ddeml.INSTANCE.DdeCreateDataHandle((int)this.idInst, pSrc, cb, cbOff, hszItem, wFmt, afCmd);
            if (returnData == null) {
                throw DdemlException.create(this.getLastError());
            }
            return returnData;
        ...
        @Override
        public void postAdvise(final Ddeml.HSZ hszTopic, final Ddeml.HSZ hszItem) {
            final boolean result = Ddeml.INSTANCE.DdePostAdvise((int)this.idInst, hszTopic, hszItem);
            if (!result) {
                throw DdemlException.create(this.getLastError());
            }
        }
        ...
        @Override
        public boolean freeStringHandle(final Ddeml.HSZ value) {
            return value == null || Ddeml.INSTANCE.DdeFreeStringHandle((int)this.idInst, value);
        }
        
        @Override
        public boolean keepStringHandle(final Ddeml.HSZ value) {
            return Ddeml.INSTANCE.DdeKeepStringHandle((int)this.idInst, value);
        }
        
        @Override
        public void abandonTransactions() {
            final boolean result = Ddeml.INSTANCE.DdeAbandonTransaction((int)this.idInst, (Ddeml.HCONV)null, 0);
            if (!result) {
                throw DdemlException.create(this.getLastError());
            }
        }
        ...
        @Override
        public IDdeConnectionList connectList(final Ddeml.HSZ service, final Ddeml.HSZ topic, final IDdeConnectionList existingList, final Ddeml.CONVCONTEXT ctx) {
            final Ddeml.HCONVLIST convlist = Ddeml.INSTANCE.DdeConnectList((int)this.idInst, service, topic, (existingList != null) ? existingList.getHandle() : null, ctx);
            if (convlist == null) {
                throw DdemlException.create(this.getLastError());
            }
        ...
        @Override
        public boolean enableCallback(final int wCmd) {
            final boolean result = Ddeml.INSTANCE.DdeEnableCallback((int)this.idInst, (Ddeml.HCONV)null, wCmd);
            if (!result && wCmd != 2) {
                final int errorCode = this.getLastError();
                if (errorCode != 0) {
                    throw DdemlException.create(this.getLastError());
        ...
        @Override
        public boolean uninitialize() {
            return Ddeml.INSTANCE.DdeUninitialize((int)this.idInst);
        }
            ...
            try {
                switch (wType) {
                    ...
                    case 8418: {
                        ...
                        final Ddeml.HDDEDATA data = Ddeml.INSTANCE.DdeCreateDataHandle(this.idInst, hszPairs[0].getPointer(), size, 0, (Ddeml.HSZ)null, wFmt, 0);
                        return new WinDef.PVOID(data.getPointer());
                    }
                    case 16400: {
