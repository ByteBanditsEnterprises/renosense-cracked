                ...
                switch (type) {
                    case EvtVarTypeAnsiString: {
                        ...
                        if (value.getClass() == String.class) {
                            ...
                            final Memory mem = new Memory((long)(((String)value).length() + 1));
                    ...
                    case EvtVarTypeBoolean: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == WinDef.BOOL.class) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((WinDef.BOOL[])value).length * 4));
                    ...
                    case EvtVarTypeEvtXml: {
                        ...
                        if (value.getClass() == String.class) {
                            this.Type = type.ordinal();
                            final Memory mem = new Memory((long)((((String)value).length() + 1) * 2));
                    ...
                    case EvtVarTypeByte: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Byte.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((byte[])value).length * 1));
                    ...
                    case EvtVarTypeUInt16: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Short.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((short[])value).length * 2));
                    ...
                    case EvtVarTypeUInt32: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Integer.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((int[])value).length * 4));
                    ...
                    case EvtVarTypeUInt64: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Long.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((long[])value).length * 4));
                    ...
                    case EvtVarTypeSingle: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Float.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((float[])value).length * 4));
                    ...
                    case EvtVarTypeDouble: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == Double.TYPE) {
                            this.Type = (type.ordinal() | 0x80);
                            final Memory mem = new Memory((long)(((double[])value).length * 4));
