    ...
    public static DomainTrust[] getDomainTrusts(final String serverName) {
        ...
        try {
            ...
            if (domainTrustCount.getValue() > 0) {
                ...
                final DsGetDC.DS_DOMAIN_TRUSTS[] domainTrusts = array = (DsGetDC.DS_DOMAIN_TRUSTS[])domainTrustRefs.toArray((Structure[])new DsGetDC.DS_DOMAIN_TRUSTS[domainTrustCount.getValue()]);
