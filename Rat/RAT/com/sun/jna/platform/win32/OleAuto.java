...
{
    public static final OleAuto INSTANCE = (OleAuto)Native.load("OleAut32", (Class)OleAuto.class, (Map)W32APIOptions.DEFAULT_OPTIONS);
    ...
    int VariantTimeToSystemTime(final double p0, final WinBase.SYSTEMTIME p1);
    ...
    public static class DISPPARAMS extends Structure
    {
        ...
        public void setRgdispidNamedArgs(OaIdl.DISPID[] namedArgs) {
            ...
            this.rgdispidNamedArgs = (Pointer)new Memory((long)(OaIdl.DISPID.SIZE * namedArgs.length));
