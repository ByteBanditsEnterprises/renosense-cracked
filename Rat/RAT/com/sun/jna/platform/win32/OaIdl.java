...
public interface OaIdl
{
    ...
    public static class DATE extends Structure
    {
        ...
        public Date getAsJavaDate() {
            ...
            final Calendar calendar = systemtime.toCalendar();
        ...
        public void setFromJavaDate(final Date javaDate) {
            ...
            final DoubleByReference pvtime = new DoubleByReference();
            OleAuto.INSTANCE.SystemTimeToVariantTime(new WinBase.SYSTEMTIME(calendar), pvtime);
            final double value = pvtime.getValue();
            this.date = value + Math.signum(value) * calendar.get(14) / 8.64E7;
        }
    ...
    public static class SAFEARRAY extends Structure implements Closeable
    {
        ...
        public static ByReference createSafeArray(final WTypes.VARTYPE vartype, final int... size) {
            ...
            final ByReference data = OleAuto.INSTANCE.SafeArrayCreate(vartype, new WinDef.UINT(size.length), rgsabound);
            return data;
        }
        ...
        public void putElement(final Object arg, final int... indices) {
            ...
            switch (this.getVarType().intValue()) {
                case 11: {
                    ...
                    final WinNT.HRESULT hr = OleAuto.INSTANCE.SafeArrayPutElement(this, paramIndices, (Pointer)mem);
                    COMUtils.checkRC(hr);
                    break;
                }
                case 16:
        ...
        public Object getElement(final int... indices) {
            ...
            switch (this.getVarType().intValue()) {
                case 11: {
                    final Memory mem = new Memory(2L);
                    final WinNT.HRESULT hr = OleAuto.INSTANCE.SafeArrayGetElement(this, paramIndices, (Pointer)mem);
                    COMUtils.checkRC(hr);
        ...
        public int getLBound(final int dimension) {
            ...
            final WinNT.HRESULT res = OleAuto.INSTANCE.SafeArrayGetLBound(this, new WinDef.UINT(targetDimension), bound);
            COMUtils.checkRC(res);
        ...
        public int getUBound(final int dimension) {
            final int targetDimension = this.getDimensionCount() - dimension;
            final WinDef.LONGByReference bound = new WinDef.LONGByReference();
            final WinNT.HRESULT res = OleAuto.INSTANCE.SafeArrayGetUBound(this, new WinDef.UINT(targetDimension), bound);
            COMUtils.checkRC(res);
            return bound.getValue().intValue();
        }
