...
public final class Platform
{
    ...
    public static final boolean is64Bit() {
        ...
        return "x86-64".equals(Platform.ARCH) || "ia64".equals(Platform.ARCH) || "ppc64".equals(Platform.ARCH) || "ppc64le".equals(Platform.ARCH) || "sparcv9".equals(Platform.ARCH) || "mips64".equals(Platform.ARCH) || "mips64el".equals(Platform.ARCH) || "loongarch64".equals(Platform.ARCH) || "amd64".equals(Platform.ARCH) || "aarch64".equals(Platform.ARCH) || Native.POINTER_SIZE == 8;
    }
    ...
    public static final boolean isLoongArch() {
        return Platform.ARCH.startsWith("loongarch");
    }
    ...
    static {
        ...
        HAS_DLL_CALLBACKS = (Platform.osType == 2 && !Platform.ARCH.startsWith("aarch"));
