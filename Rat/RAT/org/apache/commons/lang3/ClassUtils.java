...
public class ClassUtils
{
    ...
    public static boolean isAssignable(Class<?>[] classArray, Class<?>[] toClassArray, final boolean autoboxing) {
        ...
        if (classArray == null) {
            classArray = (Class<?>[])ArrayUtils.EMPTY_CLASS_ARRAY;
        }
        if (toClassArray == null) {
            toClassArray = (Class<?>[])ArrayUtils.EMPTY_CLASS_ARRAY;
        }
    ...
    public static Class<?>[] toClass(final Object... array) {
        ...
        if (array.length == 0) {
            return (Class<?>[])ArrayUtils.EMPTY_CLASS_ARRAY;
        }
    ...
    public static Iterable<Class<?>> hierarchy(final Class<?> type, final Interfaces interfacesBehavior) {
        final MutableObject<Class<?>> next;
        final Iterable<Class<?>> classes = () -> {
            next = new MutableObject<Class<?>>(type);
            return new Iterator<Class<?>>() {
                ...
                @Override
                public Class<?> next() {
                    final Class result = this.val$next.getValue();
        ...
        final Set<Class<?>> seenInterfaces;
        final Iterable<Class<?>> iterable;
        final Iterator<Class<?>> wrapped;
        return () -> {
            seenInterfaces = new HashSet<Class<?>>();
            wrapped = iterable.iterator();
            return new Iterator<Class<?>>() {
                Iterator interfaces;
                ...
                public Class<?> next() {
                    if (this.interfaces.hasNext()) {
                        ...
                        return (Class<?>)nextInterface;
                    }
                    final Class nextSuperclass = this.val$wrapped.next();
